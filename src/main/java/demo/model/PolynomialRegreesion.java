 ...
 *  @author Kevin Wayne
 */
public class PolynomialRegreesion {
     ...
     */
    public PolynomialRegreesion(double[] x, double[] y, int degree) {
        this(x, y, degree, "n");
    }
     ...
     * @throws IllegalArgumentException if the lengths of the two arrays are not equal
     */
    public PolynomialRegreesion(double[] x, double[] y, int degree, String variableName) {
        this.degree = degree;
    ...
    public String toString() {
        ...
        while (j >= 0) {
            if      (j == 0) s.append(" " + beta(j));
            else if (j == 1) s.append(" " + beta(j));
            else             s.append(" " + beta(j));
            j--;
        }
        return s.toString();
    }
